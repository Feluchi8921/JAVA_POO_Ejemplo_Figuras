...
public class ManejadorDeFiguras {
    ...
    public static void main(String[] args) {
        ...
        //f1.getArea();
        //f1 = c1;
        //((Rectangulo)f1).getLado1(); // Puede dar error en tiempo de ejecuci�n

        //Persona p = new Persona();
        //p.getDatosCompletos();
        //f1 = persona; // No podemos pq no hay relaci�n de herencia entre Persona y Figura

        //c1 = (Circulo)f1; // Puede dar error en tiempo de ejecuci�n
